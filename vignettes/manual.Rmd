...
```{r stability-1, results='hide', echo=TRUE}
...
```{r stabilityRange-1, results='hide', echo=TRUE}
...
```{r quality-1, results='hide', eval=TRUE, echo=TRUE}
...
```{r quality-range-1, results='hide', eval=TRUE, echo=TRUE}
k.range = c(4,6)
...
```{r getOptimalKValue, results='hide', eval=TRUE, echo=TRUE}
